...
describe("FortisVoting - 100% Working Tests", function () {
  ...
  describe("Time-based Operations (Isolated)", function () {
  ...
  describe("Voting System (Isolated)", function () {
    ...
    it("Should not allow unregistered voter to vote", async function () {
      const [owner, admin, voter1, voter2, auditor, unregisteredVoter] = await ethers.getSigners();
