//! Módulo de Validação Robusta na Camada de Aplicação
//! 
//! Implementa validação de votos e eleições na camada de aplicação,
//! seguindo os princípios do Prof. Marcos Simplicio de que blockchain
